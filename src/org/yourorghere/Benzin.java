...
public class Benzin implements GLEventListener {
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        gl.glColor3f(0,1,0);
        glu.gluSphere(q, 0.1, 24, 24); //большая сфера
            gl.glPushMatrix();
            gl.glRotatef(90, 1, 0, 0);
            gl.glRotatef(-60, 0, 1, 0);
            gl.glColor3f(0.8f,0.8f,0.8f);
            glu.gluCylinder(q, 0.01, 0.01, 0.5, 24, 1); //между большими сферами
            gl.glPopMatrix();
            gl.glPushMatrix();
            gl.glRotatef(90, 1, 0, 0);
            gl.glRotatef(60, 0, 1, 0);
        ...
        gl.glColor3f(1,0,0);
        glu.gluSphere(q, 0.03, 24, 24); //маленькая сфера
        gl.glRotatef(90, 1, 0, 0);
        gl.glColor3f(0.8f,0.8f,0.8f);
        glu.gluCylinder(q, 0.01, 0.01, 0.3, 24, 1); //к мальнькой сфере
        gl.glPopMatrix();
